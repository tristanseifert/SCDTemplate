...
my $cmd = 'bin/asm68k /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae-';
...
if ( $#args == 1 ) {
    my $asm = $args[0];
    my $bin = $args[1];
    $cmd = " /bin/asm68k /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- $asm, $bin";
} elsif ( $#args == 2 ) {
    my $asm = $args[0];
    my $bin = $args[1];
    my $lst = $args[2];
    $cmd = "bin/asm68k /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- $asm, $bin, , $lst";
} else {
    &Help();
}
